...
// modifying the main layout code to suit my needs: https://github.com/robsontenorio/mary/blob/main/src/View/Components/Main.php
class CustomMain extends Component
{
    ...
    {
        return <<<'HTML'
                 <main @class(["w-full mx-auto flex-1", "max-w-screen-2xl" => !$fullWidth])>
                <div @class([
                    "drawer lg:drawer-open h-full",
